...
> Mephisto's *Contract* is a plain-text file with the `.meph` extension.
...
- Rules execute in file order (increasing line numbers)
- Mutual exclusion groups execute in condition-match order; once matched, remaining actions in the group are skipped
