...
| [Rule Writing Guide](rule-writing-guide.en.md)      | Nine-question checklist, nine anti-patterns, scene-chain pattern, rules-vs-LLM boundary | Writing efficient, correct rules                   |
