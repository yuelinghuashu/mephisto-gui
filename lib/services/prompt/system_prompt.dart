...
String buildSystemPrompt({
  ...
  // ============================================================
  buffer.writeln('【要求】');
  buffer.writeln('严格遵循上述【格式要求】，不得偏离。');
  buffer.writeln();
  buffer.writeln('【此刻之后：】');
  buffer.writeln('现在，根据命运指引开始你的叙事。');
  buffer.writeln();
...
【语境判断】玩家输入涉及角色背景中的事物、人物或地点（如石中剑、凯伊、梅林、书斋）时，请结合当前叙事流、角色状态与所处位置，判断玩家是"正在经历、回忆、讨论还是下达指令"，据此自然演绎角色的反应——不要机械套用任何固定场景。
